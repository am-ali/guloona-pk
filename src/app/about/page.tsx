...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="pt-24 pb-12 lg:pb-16 bg-hero-gradient text-center">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="font-serif text-3xl md:text-5xl lg:text-6xl text-foreground mb-4 lg:mb-6">
            Our Story
          </h1>
          <p className="font-script text-lg md:text-2xl text-primary mb-4 lg:mb-6" style={{ color: "color-mix(in hsl, hsl(var(--primary)) 80%, black 20%)" }}>
      ...
      <section className="py-12 lg:py-16 bg-background">
        <div className="max-w-4xl mx-auto px-4">
          <Card className="p-6 md:p-8 lg:p-12 shadow-soft text-center">
            <div className="prose prose-lg mx-auto">
              <p className="font-serif text-lg lg:text-xl text-foreground leading-relaxed mb-4 lg:mb-6">
                Guloona bloomed in 2021, rooted in soft femininity and the timeless beauty of simplicity.
              </p>
              
              <p className="font-sans text-sm lg:text-base text-muted-foreground leading-relaxed mb-4 lg:mb-6">
      ...
      <section className="py-12 lg:py-16 bg-muted/20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h2 className="font-serif text-2xl lg:text-4xl text-foreground mb-3 lg:mb-4">Meet Our Team</h2>
          <p className="font-sans text-sm lg:text-lg text-muted-foreground mb-8 lg:mb-12 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <Card className="p-4 lg:p-6 shadow-card hover:shadow-soft transition-all duration-300">
              <div className="w-20 h-20 lg:w-32 lg:h-32 bg-primary/20 rounded-full mx-auto mb-4 lg:mb-6 flex items-center justify-center">
                <Heart className="w-8 h-8 lg:w-12 lg:h-12 text-primary" />
              </div>
              <h3 className="font-serif text-lg lg:text-xl text-foreground mb-2">Founder & Designer</h3>
            ...
            <Card className="p-4 lg:p-6 shadow-card hover:shadow-soft transition-all duration-300">
              <div className="w-20 h-20 lg:w-32 lg:h-32 bg-secondary/20 rounded-full mx-auto mb-4 lg:mb-6 flex items-center justify-center">
                <Users className="w-8 h-8 lg:w-12 lg:h-12 text-secondary" />
              </div>
              <h3 className="font-serif text-lg lg:text-xl text-foreground mb-2">Artisan Team</h3>
              <p className="font-sans text-sm lg:text-base text-muted-foreground">
            ...
            <Card className="p-4 lg:p-6 shadow-card hover:shadow-soft transition-all duration-300">
              <div className="w-20 h-20 lg:w-32 lg:h-32 bg-accent/20 rounded-full mx-auto mb-4 lg:mb-6 flex items-center justify-center">
                <Globe className="w-8 h-8 lg:w-12 lg:h-12 text-accent" />
              </div>
              <h3 className="font-serif text-lg lg:text-xl text-foreground mb-2">Community Relations</h3>
              <p className="font-sans text-sm lg:text-base text-muted-foreground">
      ...
      <section className="py-12 lg:py-16 bg-background">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12 lg:mb-16">
            <h2 className="font-serif text-2xl lg:text-4xl text-foreground mb-3 lg:mb-4">Our Values</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            {values.map((value, index) => (
              <Card key={index} className="p-6 lg:p-8 shadow-card hover:shadow-soft transition-all duration-300 animate-fade-in" style={{ animationDelay: `${index * 200}ms` }}>
                <div className="flex items-start space-x-4 lg:space-x-6">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 lg:w-16 lg:h-16 bg-primary/20 rounded-full flex items-center justify-center">
                      <value.icon className="w-6 h-6 lg:w-8 lg:h-8 text-primary" />
                    </div>
                  </div>
                  <div>
                    <h3 className="font-serif text-lg lg:text-xl text-foreground mb-2 lg:mb-3">{value.title}</h3>
                    <p className="font-sans text-sm lg:text-base text-muted-foreground leading-relaxed">{value.description}</p>
                  </div>
                </div>
              </Card>
            ))}
      ...
      <section className="py-12 lg:py-16 bg-primary/10">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="font-serif text-2xl lg:text-4xl text-foreground mb-4 lg:mb-6">
            Join Our Story
          </h2>
          <p className="font-sans text-sm lg:text-lg text-muted-foreground mb-6 lg:mb-8 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              ...
              className="inline-flex items-center justify-center bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 lg:px-8 py-2.5 lg:py-3 rounded-full font-medium hover:scale-105 transition-transform duration-300 text-sm lg:text-base"
            >
              Follow Our Journey
            </a>
          </div>
